...
data = pd.read_csv("file:/C:/Users/lm_pa/Desktop/harshita/heart.csv", encoding='ANSI')
data.columns
data.head()
...
l2 = plt.plot(classifiers, no_heart_disease, color='r', marker='o', linestyle='dashed', markerfacecolor='y',
              markersize=10)
